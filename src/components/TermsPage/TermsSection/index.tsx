  ...
  return (
    <div className="terms-section">
      <div className="terms-section--container column-layout">
        ...
        <p>Welcome to Infinite reserve!</p>

        <p>
          These terms and conditions outline the rules and regulations for the
          use of Infinite reserve's Website, located at https://ir.ioak.io.
        </p>

        <p>
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use Infinite reserve if you do not
        ...
        <p>
          We employ the use of cookies. By accessing Infinite reserve, you
          agreed to use cookies in agreement with the Infinite reserve's Privacy
          Policy.
        </p>
        ...
        <p>
          Unless otherwise stated, Infinite reserve and/or its licensors own the
          intellectual property rights for all material on Infinite reserve. All
          intellectual property rights are reserved. You may access this from
          Infinite reserve for your own personal use subjected to restrictions
          set in these terms and conditions.
        </p>

        <p>You must not:</p>
        <ul>
          <li>Republish material from Infinite reserve</li>
          <li>Sell, rent or sub-license material from Infinite reserve</li>
          <li>Reproduce, duplicate or copy material from Infinite reserve</li>
          <li>Redistribute content from Infinite reserve</li>
        </ul>
        ...
        <p>
          ...
          Infinite reserve does not filter, edit, publish or review Comments
          prior to their presence on the website. Comments do not reflect the
          views and opinions of Infinite reserve,its agents and/or affiliates.
          ...
          Infinite reserve shall not be liable for the Comments or for any
        ...
        <p>
          Infinite reserve reserves the right to monitor all Comments and to
        ...
        <p>
          You hereby grant Infinite reserve a non-exclusive license to use,
        ...
        <p>
          ...
          the hyperlink compensates the absence of Infinite reserve; and (d) the
        ...
        <p>
          ...
          sending an e-mail to Infinite reserve. Please include your name, your
        ...
        <p>
          No use of Infinite reserve's logo or other artwork will be allowed for
